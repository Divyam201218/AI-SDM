...
module.exports = async (req, res) => {
  try {
    const { board, classNumber, subject, chapter, topic, prompt } = req.body;
    ...
    const message = `
Create a formal, structured lesson plan only for:
...
Do not include any conversational or explanatory lines like “Here is a lesson...” or “In this lesson, we will...”
Use only formal lesson formatting with study materials and maybe some youtube videos.
